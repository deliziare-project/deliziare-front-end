...
// import { GoogleLogin } from '@react-oauth/google'; // Make sure this is installed and configured
...
//           <Image src="/authImages/login.png" alt="Login Illustration" width={400} height={400} className="object-cover" />
//         </div>
